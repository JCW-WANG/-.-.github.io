...
const keyTermsData = [
    {
        ...
        desc: "領導者讓員工參與決策、大量授權、鼓勵共同參與決定工作目標與方法，並透過有效的回饋來發展員工能力。領導者像是教練、引導者。",
        example: "領導者開會時，先聽取大家意見，再找出大家都同意的決策。"
    },
    {
        id: 2,
        term: "Leadership",
        translation: "領導",
        desc: "一個引導團隊、影響團隊以達成目標的過程。",
        example: "「風雨過後的指揮官」: 先強調任務分工、行動紀律，同時也親自清理，關懷士兵與居民，最後達成任務目標。"
    },
    {
        id: 3,
        term: "Intrinsic motivation",
        translation: "內在動機",
        desc: "個人因為本身的興趣、成就感等而願意去做某件事，即使沒有外在獎勵也願意。",
        example: "在畫畫前告知畫完會有獎勵，結果未畫完；即使之後不給獎勵了，還是會繼續畫完的人。"
    },
    {
        id: 4,
        term: "Extrinsic motivation",
        translation: "外在動機",
        desc: "個人因為想獲得外部獎賞或避免懲罰而進行某行為，不是發自內心想去做，而是因為有「誘因」或「壓力」才做。",
        example: "在畫畫前告知畫完會有獎勵，結果未畫完，但在之後不給獎勵後，就不畫了。"
    },
    {
        id: 5,
        term: "Training and development",
        translation: "訓練與發展",
        desc: "訓練著重目前工作上所需之知識與技能(短期)；發展著重於員工個人成長與未來能力(長期)。",
        example: "訓練: 系統/機器操作；發展: 帶團隊(領導課程)。"
    },
    {
        id: 6,
        term: "Cafeteria benefit plans",
        translation: "自助餐式福利計劃",
        desc: "企業提供一套基本福利，由員工依照自己的需求狀況，在一定額度內點選它們所需的額外福利。",
        example: "員工可以在額度內選擇進修補助、健身房補助、保險或子女教育津貼等。"
    },
    {
        id: 7,
        term: "Marketing mix",
        translation: "行銷組合",
        desc: "包含 Product(產品) + Price(價格) + Place(通路) + Promotion(推廣)。",
        example: "星巴克：Product(放鬆氛圍)、Price(中高價)、Place(市區/APP)、Promotion(買一送一)。"
    },
    {
        id: 8,
        term: "Segmentation",
        translation: "市場區隔",
        desc: "針對目標市場，依照變數(人口/地理/心理/行為)進行區隔。將大異質市場變為小同質市場。",
        example: "Netflix 使用行為區隔來根據觀眾的觀看習慣推薦內容。"
    },
    {
        id: 9,
        term: "Positioning",
        translation: "產品定位",
        desc: "定義品牌價值並與對手差異化，在顧客心中佔有獨特位置，讓顧客知道「為什麼要選你」。",
        example: "價格定位；以價格差異建立競爭優勢(如廉價航空)。"
    },
    {
        id: 10,
        term: "Marketing",
        translation: "行銷",
        desc: "一套包含創造、溝通與傳達價值給對方的程序。重點在於先確定顧客需要，才去生產符合需要的產品。",
        example: "保險公司根據疫情趨勢與顧客焦慮，設計防疫表單並透過多通路推廣。"
    },
    {
        id: 11,
        term: "The product life cycle",
        translation: "產品生命週期",
        desc: "產品從導入期(Introduction)、成長期(Growth)、成熟期(Maturity)到衰退期(Decline)的過程。",
        example: "導入: Vision Pro; 成長: 摺疊機; 成熟: iPhone; 衰退: iPod。"
    }
];
...
const quizData = [
    ...
    // --- True / False (Ch11) ---
    {
        ...
        answer: false,
        explanation: "錯誤。現代 HR 也關注員工的工作生活平衡與家庭福利。"
    },
    {
    ...
    },
    {
        ...
        answer: false,
        explanation: "錯誤。多元化能帶來創新與更廣的市場，具備經濟效益。"
    },
    {
    ...
    },
    {
        ...
        answer: false,
        explanation: "錯誤。明確的溝通期望對所有員工都是必要的。"
    },
    {
        id: 130, type: "tf", category: "Ch11 人資",
        question: "績效評估僅對新人與基層主管有用、對高階管理幾乎無價值。",
        answer: false,
        explanation: "錯誤。高階主管也需要評估（如 360 度評估）。"
    },
    {
    ...
    // --- True / False (Ch13) ---
    {
        ...
        answer: false,
        explanation: "錯誤。應為：消費者導向、服務導向、利潤導向(Profit orientation)。"
    },
    {
    ...
    },
    {
        ...
        answer: false,
        explanation: "錯誤。應稱為 4P (Product, Price, Place, Promotion)。"
    },
    {
        id: 136, type: "tf", category: "Ch13 行銷",
        question: "行銷過程包含關於如何以最佳方式將產品交付給消費者的決策。",
        answer: true,
        explanation: "正確。這屬於通路 (Place) 的決策。"
    },
    {
    ...
    },
    {
        ...
        answer: false,
        explanation: "錯誤。這符合「關係行銷」理念；大眾行銷則是一視同仁地銷售。"
    },
    ...
    },
    {
        ...
        answer: false,
        explanation: "錯誤。人員銷售通常成本極高（以單次接觸計算）。"
    },
    {
    ...
    },
    {
        ...
        answer: false,
        explanation: "錯誤。通常說法相反，或指公關是行銷的一部分。公關更側重形象維護。"
    },
    {
    ...
    // --- Multiple Choice (Ch7) ---
    {
        ...
        correctIndex: 1,
        explanation: "當代管理重視團隊協作與扁平化組織 (Working in teams)。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "現代管理者角色轉變為教練或引導者(Coach/Guide/Organizer)。"
    },
    {
        ...
        correctIndex: 3,
        explanation: "這些涉及與人互動，屬於人際關係技能(Human relations)。"
    },
    {
        ...
        correctIndex: 3,
        explanation: "建立願景是「領導(Leadership)」的核心功能。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "參與式(Participative)強調共同決策與傾聽。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 1,
        explanation: "沒有最好的風格，只有最適合情境的風格(情境領導)。"
    },
    {
        ...
        correctIndex: 1,
        explanation: "緊急狀況需快速決策，專制領導較有效率。"
    },
    {
    ...
    // --- Multiple Choice (Ch10) ---
    {
        ...
        correctIndex: 3,
        explanation: "源自內心的成就感屬於內在獎酬(Intrinsic)。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "來自外部(如獎金、讚賞)屬於外在獎酬(Extrinsic)。"
    },
    {
        ...
        correctIndex: 3,
        explanation: "最高層次為自我實現(Self-actualization)。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "公平理論核心在於比較投入與產出的公平性。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 1,
        explanation: "得知表現如何屬於回饋(Feedback)。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 1,
        explanation: "許多研究顯示，工作本身的意義與挑戰性是跨世代的激勵源。"
    },
    ...
    // --- Multiple Choice (Ch11) ---
    {
        ...
        correctIndex: 2,
        explanation: "Description = Job tasks; Specifications = Human requirements。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 1,
        explanation: "這是背景調查(Background investigation)的定義。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 1,
        explanation: "訓練需求評估(Needs assessment)是首要步驟。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "職務輪調(Job rotation)有助於培養全方位觀點。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 1,
        explanation: "管理層多元化有助於反映並吸引多元市場。"
    },
    {
        ...
        correctIndex: 1,
        explanation: "Performance appraisal 是評估與決策的依據。"
    },
    {
        ...
        correctIndex: 3,
        explanation: "這類非金錢、便利生活的福利常被稱為軟性福利(Soft benefits)。"
    },
    ...
    // --- Multiple Choice (Ch13) ---
    {
        ...
        correctIndex: 2,
        explanation: "二戰後轉變為以滿足消費者需求為主的行銷觀念時代。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 1,
        explanation: "4P 即行銷組合 (Marketing Mix)。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 0,
        explanation: "Environmental scanning 是分析外部環境因素。"
    },
    {
        ...
        correctIndex: 3,
        explanation: "Consumer market 針對個人或家庭消費。"
    },
    {
        ...
        correctIndex: 0,
        explanation: "End use (自用 vs 製造/轉售) 是分類依據。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "價值觀與興趣屬於心理變數(Psychographic)。"
    },
    {
        ...
        correctIndex: 3,
        explanation: "年齡、性別、學歷屬於人口統計變數(Demographic)。"
    },
    ...
    // --- Multiple Choice (Ch14) ---
    {
        ...
        correctIndex: 1,
        explanation: "相似的一組產品稱為產品線(Product line)。"
    },
    {
        ...
        correctIndex: 1,
        explanation: "Product differentiation 意在創造獨特性。"
    },
    {
        ...
        correctIndex: 1,
        explanation: "差異化可以是實體的，也可以是心理感知的(如品牌形象)。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "隨手可得、不願花精力尋找的是便利品(Convenience good)。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 0,
        explanation: "品牌對消費者而言代表著品質承諾與降低風險。"
    },
    {
        ...
        correctIndex: 2,
        explanation: "僅標示內容物的稱為 Generic goods。"
    },
    {
        ...
        correctIndex: 1,
        explanation: "Concept testing 是在開發早期測試市場反應。"
    },
    {
        ...
        correctIndex: 0,
        explanation: "成長期(Growth)特徵為銷量飆升、競爭者進入。"
    },
    {
        ...
        correctIndex: 3,
        explanation: "這稱為價格領導(Price leadership)。"
    }
];
...
function switchTab(tabName) {
    ...
    // 找到被點擊的那個按鈕 (透過 onclick 事件觸發的 target 可能會是 icon，所以要找 button)
    ...
    keyTermsData.forEach(item => {
        ...
        card.innerHTML = `
            ...
            <div class="input-area">
                ...
                <button class="reveal-btn" onclick="toggleTermAnswer(this, ${item.id})">
...
function toggleTermAnswer(btn, id) {
...
function renderQuiz(filterType) {
    ...
    filteredData.forEach(q => {
        ...
        // 為了安全起見，我們將 ID 存在 dataset 或直接傳給函數，而不是把解釋文字傳進 HTML 屬性
        ...
        if (q.type === 'tf') {
            // 是非題
            optionsHtml = `
                <button class="option-btn" onclick="checkAnswer(this, ${q.id}, true)">True (正確)</button>
                <button class="option-btn" onclick="checkAnswer(this, ${q.id}, false)">False (錯誤)</button>
            `;
        } else if (q.type === 'mc') {
            // 選擇題
            q.options.forEach((opt, idx) => {
                optionsHtml += `
                    <button class="option-btn" onclick="checkAnswer(this, ${q.id}, ${idx})">
...
function checkAnswer(btnElement, questionId, userChoice) {
    // 1. 從資料庫找題目 (這是修復 Bug 的關鍵)
    ...
    // 3. 比對答案
    const isCorrect = (userChoice === questionData.answer) || (userChoice === questionData.correctIndex);

    if (isCorrect) {
        btnElement.classList.add('correct');
        feedbackBox.innerHTML = `<i class="fas fa-check-circle"></i> <strong>答對了！</strong><br>${questionData.explanation}`;
        ...
        allBtns.forEach((btn, idx) => {
            if (questionData.type === 'tf') {
                ...
                const isTrueBtn = btnText.includes('True');
                if (questionData.answer === isTrueBtn) {
        ...
        feedbackBox.innerHTML = `<i class="fas fa-times-circle"></i> <strong>答錯了。</strong><br>${questionData.explanation}`;
